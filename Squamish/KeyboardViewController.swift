...
class KeyboardViewController: UIInputViewController {
    ...
    func addEBtn() {
        ...
        self.eButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        // TODO:
        // width and height constraints to match the default ios keyboard buttons
        ...
        let widthContraint =  NSLayoutConstraint(item: self.eButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addABtn() {
        ...
        self.aButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.aButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addIBtn() {
        ...
        self.iButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.iButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addUBtn() {
        ...
        self.uButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.uButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addPBtn() {
        ...
        self.pButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.pButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addTBtn() {
        ...
        self.tButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.tButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addCBtn() {
        ...
        self.cButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.cButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addHBtn() {
        ...
        self.hButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.hButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addSBtn() {
        ...
        self.sButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.sButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addKBtn() {
        ...
        self.kButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.kButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addWBtn() {
        ...
        self.wButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.wButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addMBtn() {
        ...
        self.mButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.mButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addM2Btn() {
        ...
        self.m2Button.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.m2Button, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addNBtn() {
        ...
        self.nButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.nButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addLBtn() {
        ...
        self.lButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.lButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addK2Btn() {
        ...
        self.k2Button.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.k2Button, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addN2Btn() {
        ...
        self.n2Button.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.n2Button, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addL2Btn() {
        ...
        self.l2Button.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.l2Button, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addSevenBtn() {
        ...
        self.sevenButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.sevenButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addX2Btn() {
        ...
        self.x2Button.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.x2Button, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addE2Btn() {
        ...
        self.e2Button.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.e2Button, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addU2Btn() {
        ...
        self.u2Button.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.u2Button, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addYBtn() {
        ...
        self.yButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.yButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addApostropheBtn() {
        ...
        self.apostropheButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
        ...
        let widthContraint =  NSLayoutConstraint(item: self.apostropheButton, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 40)
    ...
    func addDeleteBtn() {
        ...
        self.deleteButton.titleLabel?.font = UIFont.systemFont(ofSize: 22)
